...
| ndq.3.6 (WP11f gateway E2E) | wp9-wp11 §4.4, §9.9 | 0023 | requires the founder gateway-profile decision (ticket wp11-gateway-profile) before any certification claim |
...
| WP11-gateway-profile | wp9-wp11 §4.4 | 0023 | one-page FOUNDER decision naming the reference gateway |
